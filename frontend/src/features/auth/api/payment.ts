...
function normalizeInvoice(raw: unknown): Invoice {
  ...
  return {
    ...
    period_start: typeof record.period_start === 'string' ? record.period_start : typeof record.periodStart === 'string' ? record.periodStart : undefined,
    period_end: typeof record.period_end === 'string' ? record.period_end : typeof record.periodEnd === 'string' ? record.periodEnd : undefined,
