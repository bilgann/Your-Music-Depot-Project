...
export default function ScheduleLessonModal({ existingLesson, onSaved, onClose }: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (roomCapacity && formData.student_ids.length > roomCapacity) {
      toast(`Room capacity is ${roomCapacity}. Remove ${formData.student_ids.length - roomCapacity} student(s).`, 'error')
      return
    }
